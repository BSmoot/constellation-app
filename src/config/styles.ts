...
export const styles = {
  ...
  form: {
    ...
    input: 'w-full px-4 py-3 rounded-lg border border-dark/20 bg-white/80 backdrop-blur-sm focus:outline-none focus:border-secondary transition-colors duration-200',
