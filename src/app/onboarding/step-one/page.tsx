...
export default function StepOnePage() {
  return (
    <main className="min-h-screen bg-[#E9F1F7] flex items-center justify-center">
      ...
      <header className="mb-8 space-y-2"> {/* Use space-y instead of fixed heights */}
          <div className="h-[48px] flex items-center justify-center"> {/* Fixed height for h1 */}
            <h1 className="text-4xl md:text-5xl font-bold text-dark font-jakarta">
              Let's Make History!
            </h1>
          </div>
          <div className="h-[32px] flex items-center justify-center"> {/* Fixed height for subheader */}
